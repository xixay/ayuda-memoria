...
VALUES
  ...
  ;
--###  ---TABLA DICTAMEN UAI
 select * from controleg_dictamen.dictamen_uai du
;
--###  ---TODOS LOS PROCESOS
select * from controleg_proceso.proceso
;
--###  ---TABLA DONDE ESTARAN TODOS LOS TIPOS DE PROCESOS
select * from parametricas.tipo_proceso_datos_adicionales tpda 
;
--###  ---TABLA ESTADO CLASIFICACION
select * from parametricas.estado_clasificacion ec where ec.tippro_codigo in ()
select * from parametricas.estado_control eco
select * from parametricas.estado_etapa ee
select *from parametricas.tipo_proceso tp
select * from controleg_proceso.proceso p
select *from parametricas.tipo_responsabilidad tr
select *from parametricas.tipo_sancion ts
...
select * from controleg_persona.representante_legal rl 
;
