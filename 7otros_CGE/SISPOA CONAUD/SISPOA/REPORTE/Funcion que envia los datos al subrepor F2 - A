...
$F{iac_recomendacion_seguir} != null ? "\"" + $F{iac_recomendacion_seguir}.toString().replaceAll("\\\\", "\\\\\\\\").replaceAll("\"", "\\\\\"") + "\"" : null,
$F{nro_recomendaciones} != null ? "\"" + $F{nro_recomendaciones}.toString().replaceAll("\\\\", "\\\\\\\\").replaceAll("\"", "\\\\\"") + "\"" : null,
