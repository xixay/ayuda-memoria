...
export const getArticulos = async (solicitud: Request, respuesta: Response): Promise<Response> => {
    const repositorioArticulo = AppDataSource.getRepository(Articulo)
    try {
        //hacer la consulta
        const response = await repositorioArticulo.find()
...
export const getArticuloById = async (solicitud: Request, respuesta: Response): Promise<Response> => {
    ...
    try {
        ...
        //hacer la consulta
        const response = await repositorioArticulo.findOneBy({ id: idArticulo })
...
export const updateArticulo = async (solicitud: Request, respuesta: Response): Promise<Response> => {
    ...
    try {
        ...
        //hacer la consulta
        const updateArticulo = await repositorioArticulo.findOneBy({ id: idArticulo })
...
export const deleteArticulo = async (solicitud: Request, respuesta: Response): Promise<Response> => {
    ...
    try {
        ...
        //hacer la consulta
        const deleteArticulo = await repositorioArticulo.findOneBy({ id: idArticulo })
