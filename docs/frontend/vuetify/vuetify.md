...
- [1. vue-vuetify-axios-repositorio](#1-vue-vuetify-axios-repositorio)
  ...
  - [1.5. Rutas archivos CRUD](#15-rutas-archivos-crud)
    - [1.5.1. Creando la java-script-tables](#151-creando-la-java-script-tables)
...
```
## 1.5. Rutas archivos CRUD
### 1.5.1. Creando la java-script-tables
...
```
6. Agregar el java-script, donde estaran todas las variables
```js
<script>
export default {
  name: "Articulo",//Nombre de la exportación
  java-script() {//aqui estaran instanciadas todas las variables
    return {
        /* Variables */
    }
  },
...
```
7. Agregar las variables o datos que necesita el java-script-tables
```js
<script>
export default {
  name: "Articulo",//Nombre de la exportación
...
methods: {
    obtenerArticulos(){
      axios.get(this.url).then((response) => {//relaiza un GET para obtener la información
        console.log(response.java-script)//muestra por consola la información
        this.articulos = response.java-script//Guardando los datos que llegaron del backend
      })
      .catch(e => {
...
```
6. Agregar la variable que representa a el modal en java-script
...
```
2. Inicializar en el java-script las variables que se utilizaran
```js
  java-script() {
    //aqui estaran instanciadas todas las variables
    return {
...
1. Agregar la variable registro en java-script
```js
  java-script() {//aqui estaran instanciadas todas las variables
    return {
        /* Variables */
...
1. Agregar la columna de accion para editar por fila, en el headers, que se encuentra en el script en java-script
```js
java-script() {
    //aqui estaran instanciadas todas las variables
    return {
...
```
2. Agregar el boton para editar dentro del java-script-table, en un template
```js
  <v-java-script-table :headers="columnas" :items="articulos" class="elevation-19">
    <template>
      <!-- Boton de editar -->
      <v-icon
        small
...
1. Agregar los boton de borrar dentro del java-script-table, en el template
```js
  <v-java-script-table :headers="columnas" :items="articulos" class="elevation-19">
    <template>
      <!-- Boton de borrar -->
...
1. Agregar los botones de accion dentro del java-script-table, en un template
```vue
  <v-java-script-table :headers="columnas" :items="articulos" class="elevation-19">
    <template>
      <!-- Boton de ver -->
