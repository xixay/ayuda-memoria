...
- En la carpeta src crear el archivo java-script-source.ts
```ts
...
```json
"emitDecoratorMetajava-script": true,
...
- En app.ts importar el java-script-source y la entidad
```ts
// lib/app.ts
import express from "express"
import cors from "cors"
import bodyParser from "body-parser"
// importando entidades y java-script-source
