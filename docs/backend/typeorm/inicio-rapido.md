...
## 2. crear el proyecto
```console
npx typeorm init --name MyProject --java-scriptbase prueba_db
```
...
```console
pimagenes -h 172.17.0.6 -U postgres -W
```
- password
```console
Contraseña:postgres
...
Inserting a new user into the java-scriptbase...
Saved a new user with id: 1
Loading users from the java-scriptbase...
