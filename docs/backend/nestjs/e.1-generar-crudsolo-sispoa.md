...
```console
npx ts-node src/common/archivos/feature.generator.ts TipoAreasUnidades parametricas
```
- Estando en el esquema estructura_organizacional
```console
npx ts-node src/common/archivos/feature.generator.ts Items estructura_organizacional
```
