...
```
- Configuración de GitHub para el subsistema de windows para linux, debe asegurarse de informarle a su entorno de windows linux, sobre su archivos de gitHuib, proporcionandole un usuario y correo
```console
