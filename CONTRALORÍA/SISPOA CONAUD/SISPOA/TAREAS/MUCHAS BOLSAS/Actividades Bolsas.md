...
| d         | 150            |                 |
```
tengo actividades que estan en un grupo llamado F-26, y me cree otra actividad de otro grupo llamado F21 en el sistema SISPOA,
las actividades en F26, tienen horas disponibles, ahora al registrar una actividad nueva en F21, tengo que asignarle otra actividad de las que ya hay en F-26 seria como la bolsa, actualmente mi tabla actividades tiene estos atributos, el cual es el siguiente

-- DDL generated by DBeaver
-- WARNING: It may differ from actual native database DDL
CREATE TABLE control_archivos.actividades (
	act_codigo int4 NOT NULL,
	act_numero varchar NULL,
	act_descripcion varchar NULL,
	act_cantidad int4 NULL,
	act_fecha_inicio date NULL,
	act_fecha_fin date NULL,
	act_objeto varchar NULL,
	act_objetivo varchar NULL,
	act_alcance varchar NULL,
	act_horas_planificadas int4 NULL,
	ent_codigo int4 NOT NULL,
	fob_codigo int4 NULL,
	ume_codigo int4 NOT NULL,
	ttr_codigo int4 NOT NULL,
	tipact_codigo int4 NOT NULL,
	cac_codigo int4 NOT NULL,
	sec_codigo int4 NOT NULL,
	aun_codigo_supervisora int4 NOT NULL,
	act_justificacion varchar NULL,
	act_estado int4 NOT NULL,
	usuario_registro int4 NOT NULL,
	usuario_modificacion int4 NOT NULL,
	usuario_baja int4 NOT NULL,
	fecha_registro timestamp NOT NULL,
	fecha_modificacion timestamp NOT NULL,
	fecha_baja timestamp NOT NULL,
	act_denuncia varchar NULL,
	act_codigo_anterior int4 NULL,
	aun_codigo_ejecutora int4 NULL,
	pobj_codigo int4 NOT NULL,
	act_correlativo int4 NULL,
	act_no_planificado bool NOT NULL,
	act_codigo_bolsa int4 NULL,
	iac_codigo_apoyo int4 NULL,
	caa_codigo int4 NULL,
	cfa_codigo int4 NULL,
	cga_codigo int4 NULL,
	cca_codigo int4 NULL,
	act_ejecucion_conaud bool NULL,
	ent_descripcion varchar NULL
);

hay un atributo llamado act_codigo_bolsa, que es la actividad F26, que se refiere,

la actividad nueva que se creo esta en edicion, pero una ves que se consolide, se puede iniciar en otro sistema llamado CONAUD
, una ves iniciada en CONAUD, se puede disponer recien de las horas disponibles, si que hay de la actividad bolsa
Actualmente esta logica funciona para que una actividad de F21, tenga una actividad bolsa F26

Pero ahora la actividad en F21, puede tener n bolsas, porque una ves iniciada en CONAUD, podra escoger las horas de las n bolsas que tiene, por ejm la Act 5 de tipo F21 solo de las que se iniciaron en CONAUD,necesita 200 horas, y tiene a su disposicion 4 actividades bolsas:
Act1 esta iniciada en conaud, tiene 0 horas disponibles
Act2 NO esta iniciada en conaud, tiene 200 horas disponibles(ojo no esta iniciada)
Act3 esta iniciada en conaud, tiene 150 horas disponibles
Act4 esta iniciada en conaud, tiene 50 horas disponibles
